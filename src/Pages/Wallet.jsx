  ...
  return (
   <section className='h-svh pt-40'>
       ...
       <div className='pl-6 mb-3'>
        ...
        <input className='border border-gray-500 outline-amber-500 w-[400px] h-10 rounded-lg pl-3' type="text" name='' id='' placeholder='Case bank' />
       </div>
